...
import { createOrbit, updateTopic, createTopic } from '../lib/db.js'
      ...
      <div>
        <div style={{ padding: '18px 32px', borderBottom: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', gap: 12, position: 'sticky', top: 0, background: '#0d0d0b', zIndex: 10 }}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
            ...
            <button style={{ padding: '7px 14px', background: 'rgba(255,255,255,0.04)', border: `1px solid ${C.border}`, borderRadius: 8, color: C.text2, fontSize: 12.5, cursor: 'pointer', fontFamily: "'Geist', system-ui, sans-serif" }} onClick={() => onNavigate('importar')}>↑ Importar PDF</button>
          </div>
        </div>
