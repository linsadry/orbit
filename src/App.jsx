...
export default function App() {
  ...
  const pages = {
    ...
    mapa: <MapaPage data={data} onNavigate={setPage} />,
      ...
      <div style={styles.loading}>
        <div style={styles.loadingInner}>
          <svg width="40" height="40" viewBox="0 0 48 48" fill="none">
            <circle cx="24" cy="24" r="4" fill="#9a6b2a" />
            <ellipse cx="24" cy="24" rx="14" ry="5.5" stroke="#9a6b2a" strokeWidth="1.6" fill="none" opacity="0.65" transform="rotate(-18 24 24)" />
            <ellipse cx="24" cy="24" rx="20" ry="4.5" stroke="#9a6b2a" strokeWidth="1" fill="none" opacity="0.28" transform="rotate(28 24 24)" />
          </svg>
      ...
      {notification && (
        <div style={{
          ...
          background: notification.type === 'error'
            ? 'rgba(181,96,58,0.12)' : 'rgba(74,124,89,0.12)',
          borderColor: notification.type === 'error'
            ? 'rgba(181,96,58,0.25)' : 'rgba(74,124,89,0.25)',
          color: '#2c2419',
        }}>
          <span style={{ color: notification.type === 'error' ? '#b5603a' : '#4a7c59', fontSize: 14 }}>
